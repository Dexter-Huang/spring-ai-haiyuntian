...
@EnableConfigurationProperties({ZhiPuChatProperties.class, ZhiPuEmbeddingProperties.class})
public class ZhiPuAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = ZhiPuChatProperties.CONFIG_PREFIX, name = "enabled", havingValue = "true",
            matchIfMissing = true)
    public ZhiPuChatClient zhiPuChatClient(ZhiPuChatProperties chatProperties) {
        // TODO
    }
